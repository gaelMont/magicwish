...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    // Petit hack pour satisfaire le linter et éviter l'erreur de setState synchrone
    // On force l'exécution au prochain cycle d'événement
  ...
  // Si pas encore monté (côté serveur), on renvoie un carré vide
  if (!mounted) {
