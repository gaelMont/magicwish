    ...
    return (
        <main className="min-h-screen bg-background pb-20">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold mb-8 text-foreground border-b border-border pb-4">
                    Mentions Légales
                </h1>

                <section className="mb-8 p-6 bg-surface rounded-lg border border-border shadow-sm">
                    ...
                    <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                        <li><strong>Propriétaire / Éditeur :</strong> MagicWish Project</li>
                        <li><strong>Responsable de la publication :</strong> MagicWish Admin</li>
